...
import wordsFirstCharUppercase from './wordsFirstCharUppercase'
...
// String functions
export {
    isAlphabetic, isAlphanumeric, isNumeric,
    lowercase, removeSpace, uppercase, firstCharUppercase
}

export { rgbToHex, hexToRgb, hexToRgba }
export {
    binaryToDecimal, binaryToHexadecimal, decimalToBinary,
    decimalToHexadecimal, hexadecimalToBinary, hexadecimalToDecimal
}
